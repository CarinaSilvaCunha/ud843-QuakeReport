...
public final class QueryUtils {
    ...
    private static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            // Get Sample JSON Response Object.
            JSONObject jsonSampleObj = new JSONObject(earthquakeJSON);

            // Getting JSON features array.
            JSONArray featuresArray = jsonSampleObj.getJSONArray("features");
            ...
            for (int i = 0; i < featuresArray.length(); i++) {
                ...
                String loc = propertiesObj.getString("place");
